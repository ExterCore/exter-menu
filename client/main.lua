...
function openMenu(data, sort, skipFirst)
    ...
    SendNUIMessage({action = "openMenu", data = table.clone(data)})
end
...
-- Events
RegisterNetEvent('exter-menu:client:openMenu', function(data, sort, skipFirst)
    openMenu(data, sort, skipFirst)
end)

RegisterNetEvent('exter-menu:client:closeMenu', function()
    closeMenu()
end)
...
RegisterNUICallback('closeMenu', function(_, cb)
    ...
    cb('ok')
    TriggerEvent("exter-menu:client:menuClosed")
end)
